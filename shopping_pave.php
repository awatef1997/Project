    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          <a href="#" class="list-group-item">paving 1</a>
          <a href="#" class="list-group-item">paving 2</a>
          <a href="#" class="list-group-item">paving 3</a>
        </div>
      ...
      <div class="col-lg-9">
        ...
        <div class="row">
          <?php
          $query = "SELECT * FROM paving_product ORDER BY id ASC";
