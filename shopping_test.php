    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          <a href="#" class="list-group-item">Decking 1</a>
          <a href="#" class="list-group-item">Decking 2</a>
          <a href="#" class="list-group-item">Decking 3</a>
        </div>
      ...
      <div class="col-lg-9">
        ...
        <div class="row">
          <?php
          $query = "SELECT * FROM decking_products ORDER BY ID ASC";
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            ...
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="<?php echo $row["image"];?>" style="width:255px; height:190px" alt=""></a>
              <div class="card-body">
                <h4 class="card-title">
                ...
                <input type="hidden" name="hidden_details" value="<?php echo $row["description"]; ?>" />
