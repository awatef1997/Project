  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-9">
        ...
        <?php
        $paving = mysqli_query($conn,"SELECT id,title,price,image,description FROM paving_product");
        $rows   = mysqli_num_rows($paving);
      //  echo "<div class='container' >";
        //echo "<h3>Welcome to Admin Panel</h3>";
        echo "amount paving products: ".$rows;
        echo "</br> </br>";
        echo "</br> </br>";
        ...
        $i = 0;
        while($retreive = mysqli_fetch_array($paving)){
          $id = $retreive['id'];
