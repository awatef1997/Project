  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-9">
        ...
        <?php
        $decks = mysqli_query($conn,"SELECT id,Title,price,images,desciption FROM fencing_products");
        $rows   = mysqli_num_rows($decks);
        //echo "<div class='container' >";
        echo "<h3></br><Welcome to Admin Panel</h3>";
        echo "Amount of fence products: ".$rows;
        echo "</br> </br>";
        ...
        while($retreive = mysqli_fetch_array($decks)){
          ...
          $fimage = $retreive['images'];
          $fdescription = $retreive['desciption'];
          echo "<tr>";
          echo "<th>".$i=$i+1; "</th>";
